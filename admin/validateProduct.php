<?php
include_once "handelProduct.php";
...
function validate_small_description($description)
{
    if (!empty($description) && strlen($description) >= 10)
    {
        return true;
    ...
    {
        $_SESSION['message'] = "Please enter a non-empty small description with at least 10 characters.";
        return false;
    }
}
